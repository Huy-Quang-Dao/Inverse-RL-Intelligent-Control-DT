...
uL[:,1]=-K_c*xL[:,1];
for q1=1:N_q-1    
    xL[:,q1+1]=A*xL[:,q1]+B*uL[:,q1];
    uL[:,q1+1]= -K_c*xL[:,q1+1];
end
# Plot
t=1:1:N_q;
p1=plot(t[:,1],xL[1,:],label="y_1")
p2=plot(t[:,1],xL[2,:],label="y_2")
p3=plot(t[:,1],xL[3,:],label="y_3")
plot(p1, p2,p3, layout=(3,1))

# t=collect(1:1:N_q);
# anim = @animate for i = 1:N_q
#     p1=plot(t[1:i],xL[1,1:i],label="y_1")
#     p2=plot(t[1:i],xL[2,1:i],label="y_2")
#     p3=plot(t[1:i],xL[3,1:i],label="y_3")
#     plot(p1, p2,p3, layout=(3,1))
# end
# gif(anim, "trajectory_fps15.gif", fps = 15)